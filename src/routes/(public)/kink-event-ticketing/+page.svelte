<script lang="ts">
	...
	let webPageStructuredData = $derived({
		...
		url: `${page.url.origin}/kink-event-ticketing`,
		inLanguage: 'en',
		isPartOf: {
			'@type': 'WebSite',
			name: 'Revel',
...
<svelte:head>
	...
	<link rel="canonical" href="{page.url.origin}/kink-event-ticketing" />

	<!-- Open Graph -->
	<meta property="og:type" content="website" />
	<meta property="og:title" content={content.meta.title} />
	<meta property="og:description" content={content.meta.description} />
	<meta property="og:url" content="{page.url.origin}/kink-event-ticketing" />
