<script lang="ts">
	...
	const content = getLandingPage('de', 'privacy-focused-events')!;

	// Generate breadcrumb structured data
	let breadcrumbData = $derived(
		generateBreadcrumbStructuredData([
			{ name: 'Startseite', url: page.url.origin },
			{ name: content.hero.headline, url: `${page.url.origin}/de/privacy-focused-events` }
		])
	);
	...
	let webPageStructuredData = $derived({
		...
		url: `${page.url.origin}/de/privacy-focused-events`,
		inLanguage: 'de',
		isPartOf: {
			'@type': 'WebSite',
			name: 'Revel',
...
<svelte:head>
	...
	<link rel="canonical" href="{page.url.origin}/de/privacy-focused-events" />

	<!-- Open Graph -->
	<meta property="og:type" content="website" />
	<meta property="og:title" content={content.meta.title} />
	<meta property="og:description" content={content.meta.description} />
	<meta property="og:url" content="{page.url.origin}/de/privacy-focused-events" />
	...
	<link rel="alternate" hreflang="en" href="{page.url.origin}/privacy-focused-events" />
	<link rel="alternate" hreflang="de" href="{page.url.origin}/de/privacy-focused-events" />
	<link rel="alternate" hreflang="it" href="{page.url.origin}/it/privacy-focused-events" />
