...
{#if status === 'draft'}
	<Badge class="bg-amber-500 text-xs text-white hover:bg-amber-600">{label}</Badge>
{:else if status === 'open'}
	<Badge class="bg-emerald-600 text-xs text-white hover:bg-emerald-700">{label}</Badge>
{:else}
