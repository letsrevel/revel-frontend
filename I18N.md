...
|----------|------|--------|------------|
| English  | `en` | ✅ Source | 100% (1,394 keys) |
| German   | `de` | ✅ Complete | 100% (1,394 keys) |
| Italian  | `it` | ✅ Complete | 100% (1,394 keys) |
...
```
revel-frontend/
├── messages/                    # Translation files (source of truth)
│   ├── en.json                 # English (source language)
│   ├── de.json                 # German translations
│   └── it.json                 # Italian translations
├── src/lib/paraglide/          # Generated runtime (DO NOT EDIT)
│   ├── messages.js             # Auto-generated message functions
│   ├── runtime.js              # Auto-generated runtime
│   └── ...
├── src/lib/i18n.ts             # i18n configuration & language detection
├── src/hooks.server.ts         # Server-side language setup
├── scripts/
...
3. **Language detection** happens server-side (URL → Cookie → Accept-Language → Default)
...
// messages/de.json
{
  "myFeature": {
    ...
    "description": "Das ist eine großartige Funktion",
...
// messages/it.json
{
  "myFeature": {
    ...
    "description": "Questa è una grande funzionalità",
...
4. **Compile translations**:
   ...
   pnpm paraglide:compile
   ```
5. **Commit all files** (messages/*.json AND src/lib/paraglide/*)
...
- ✅ Validates translations when message files change
...
- **Currency**: Always use symbols and codes (€, $, USD, EUR)
...
**Completion**: 100% across all languages ✨
